...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{packageCountUnfiltered2.pdf}
\caption{Growth of the total number of packages in the Gentoo package database over time.}\label{fig:pkgsgrowth}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{packageCountDeltaUnfiltered2.pdf}
\caption{The number of package additions and removals over time.}\label{fig:pkgsgrowthdelta}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{histo-out.pdf}
\caption{Double logarithmic histograms of the number of dependencies per package. }\label{fig:dephisto-out}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=\linewidth]{histo-in.pdf}
\caption{Double logarithmic histograms of the number of dependers per package.}\label{fig:dephisto-in}
\end{figure}
...
\begin{tabular}{llll}
\toprule
 & Package & \multicolumn{2}{l}{Reason for excluding}\\
\midrule
...
\section{The Gentoo Portage Dependency Graph}
