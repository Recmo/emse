...
No software project stands entirely on its own. Software is usually developed by taking one or more existing libraries of components and combining those \begin{wrapfigure}{r}{0.5\linewidth}
\small\centering
...
\begin{center}
\href{http://datahub.io/dataset/gentoo-dependency-graph}{\texttt{http://datahub.io/dataset/gentoo-dependency-graph}}
\end{center}
as compressed GML graphs for every snapshot. Raw data is available at
\begin{center}
\url{http://www.utwente.nl/mb/iebis/staff/amrit/timeline.squashfs}\\
\end{center}
...
% TODO: Write something about discretization noise
